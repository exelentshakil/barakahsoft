      ...
      {openPanel === kind && (
        <div className="bs-nav-panel bs-nav-panel-mega">
          <div className="flex items-stretch gap-8 w-full">
            ...
            <div className="flex flex-col bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05),_0_0_0_1px_rgba(226,232,240,1)] overflow-hidden w-[260px] shrink-0 group isolate">
