...
// calmer for a business with a longer real list of service areas. v4 --
// same sectionHref fix as AreaBadges.tsx.
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-8 columns-2 gap-6 sm:columns-3">
          {payload.areas.map((area) => (
            <a key={area.slug} href={sectionHref(payload, "areas", area.slug)} className="mb-3 flex items-center gap-2 break-inside-avoid text-sm hover:text-primary">
              {area.imageUrl ? (
