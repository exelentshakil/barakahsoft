      ...
      <main className="mx-auto max-w-7xl px-5 py-8">
        <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
          ...
          <aside className="space-y-4">
            ...
            <div className="space-y-2">
              {LEADS.map((lead) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="rounded bg-[#f0f3ff] px-1.5 py-0.5 text-[10px] font-bold text-[#533afd]">
                        {lead.trade}
                      </span>
                      <span className="text-[10px] font-bold text-[#0b8f5b]">{lead.value}</span>
                    </div>
                    <p className="mt-2 font-bold text-[#0d1738] text-sm truncate">{lead.company}</p>
                    <p className="text-xs text-[#777588]">{lead.contact} · {lead.location}</p>
                    <div className="mt-3 flex items-center justify-between border-t border-[#e5e7f2] pt-2">
                      <span className="text-[11px] font-semibold text-[#533afd]">{lead.status}</span>
            ...
            {/* Quick Metrics */}
            <div className="rounded-xl border border-[#e5e7f2] bg-white p-4 space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-[#0d1738]">$3,188.00</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#777588]">Pending Close:</span>
                <span className="font-bold text-[#533afd]">$2,391.00</span>
              </div>
            </div>
          </aside>
          ...
          <div className="space-y-6">
            {/* Top Overview Banner */}
            <div className="rounded-2xl border border-[#c7d0fb] bg-white p-6 shadow-sm flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                ...
                <h1 className="mt-1 text-2xl font-bold text-[#0d1738]">{selectedLead.company}</h1>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-md px-3.5 py-2 text-xs font-bold text-white transition ${
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-md bg-[#0b8f5b] px-3.5 py-2 text-xs font-bold text-white hover:bg-[#09744a]"
                >
                  <PhoneCall className="h-3.5 w-3.5" /> Click-to-Call
                </a>
                <button
                  onClick={() => alert(`Stripe $797 payment link generated for ${selectedLead.company}!`)}
                  className="inline-flex items-center gap-1.5 rounded-md border border-[#533afd] bg-white px-3.5 py-2 text-xs font-bold text-[#533afd] hover:bg-[#f0f3ff]"
                >
            ...
            <div className="rounded-2xl border border-[#e5e7f2] bg-white p-6 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-[#e5e7f2] pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-[#0d1738]">Inbound Lead & Verified Facts</h3>
                </div>
                <span className="rounded bg-[#eaf8f0] px-2 py-0.5 text-[10px] font-bold text-[#0b8f5b]">
                  Verified via Firecrawl
                </span>
              </div>

              <div className="grid gap-4 sm:grid-cols-3 text-xs">
                <div className="rounded-lg bg-[#f9f9ff] p-3 border border-[#e5e7f2]">
                  <span className="text-[#777588]">Selected Intake Pains:</span>
                  <p className="mt-1 font-bold text-[#0d1738]">• Nobody finds us on Google</p>
                ...
                <div className="rounded-lg bg-[#f9f9ff] p-3 border border-[#e5e7f2]">
                  <span className="text-[#777588]">Verified Credentials:</span>
                  <p className="mt-1 font-bold text-[#0d1738]">• Lic. #11288 Master Electrician</p>
                ...
                <div className="rounded-lg bg-[#f9f9ff] p-3 border border-[#e5e7f2]">
                  <span className="text-[#777588]">Extracted Brand Tokens:</span>
                  ...
                  <p className="mt-1.5 text-[11px] text-[#777588]">Logo: york-logo.png extracted</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[#e5e7f2] bg-white p-6 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-[#e5e7f2] pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-[#0d1738]">Automated Visual Audit & Queens Search Matrix</h3>
                </div>
                <span className="text-xs font-bold text-[#533afd]">Speed: 29 $\to$ 98 / 100</span>
              </div>

              <div className="grid gap-6 sm:grid-cols-[1.1fr_0.9fr] sm:items-center">
                {/* 7x7 Grid */}
                <div className="rounded-xl border border-[#e5e7f2] bg-[#f9f9ff] p-4">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#777588] block mb-2">
                  ...
                  <div className="mt-3 flex justify-between text-[10px] text-[#777588]">
                    <span>Rank #1-3 (10 Nodes)</span>
                    <span className="text-[#ba1a1a]">Missing (39 Nodes)</span>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-center">
                    <div className="rounded-lg border border-[#e5e7f2] p-2.5 bg-[#f9f9ff]">
                      <span className="text-[10px] text-[#777588]">Mobile Load Time</span>
                      <p className="text-base font-bold text-[#0b8f5b]">0.12s</p>
                    </div>
                    <div className="rounded-lg border border-[#e5e7f2] p-2.5 bg-[#f9f9ff]">
                      <span className="text-[10px] text-[#777588]">AI Schema Markup</span>
                      <p className="text-base font-bold text-[#533afd]">LocalBusiness</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-[#e5e7f2] bg-white p-6 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-[#e5e7f2] pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-[#0d1738]">Rebuilt Platform (28 Service Routes + 8 Articles)</h3>
                </div>
                <a
              ...
              <div className="grid gap-2 sm:grid-cols-2 text-xs">
                {[
                  ...
                  <div key={r.path} className="flex justify-between items-center rounded-lg border border-[#e5e7f2] p-2.5 bg-[#f9f9ff]">
                    <span className="font-semibold text-[#0d1738]">{r.name}</span>
                    <span className="rounded bg-[#eaf8f0] px-1.5 py-0.5 text-[10px] font-bold text-[#0b8f5b]">Pre-rendered</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[#e5e7f2] bg-white p-6 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-[#e5e7f2] pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-[#0d1738]">Automated Brevo Delivery & Live Proposal Link</h3>
                </div>
                <span className="text-xs font-mono text-[#777588]">magic_983 token</span>
              </div>

              <div className="rounded-xl border border-[#c7d0fb] bg-[#f0f3ff] p-4 text-xs space-y-3">
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <button
                    onClick={() => setEmailSent(true)}
                    className="rounded-md bg-[#533afd] px-4 py-2 text-xs font-bold text-white hover:bg-[#432bd9]"
                  >
            ...
            <div className="rounded-2xl bg-[#0d1738] p-6 text-white shadow-md flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                <div className="flex items-center gap-2">
                  <span className="rounded bg-[#533afd] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">
                    Final Step
                  </span>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md bg-[#533afd] px-5 py-3 text-sm font-bold text-white hover:bg-[#432bd9] shrink-0"
              >
