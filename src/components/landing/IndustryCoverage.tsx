    ...
    <section id="industries" className="border-b border-[#d9e8f4] bg-white py-24 lg:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          <div><p className="mb-4 text-xs font-bold uppercase tracking-[0.18em] text-[#0c68c8]">Industry coverage</p><h2 className="font-sans text-4xl font-semibold leading-tight tracking-[-0.04em] text-[#07284d] sm:text-5xl">A stronger website, shaped around the services you provide.</h2></div>
          <p className="max-w-xl text-lg leading-8 text-[#60778d]">We focus on US home-service businesses where trust, local relevance, and a clear contact path matter. The structure changes with the trade and the real business content.</p>
        </div>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="relative min-h-[360px] overflow-hidden rounded-3xl border border-[#c8ddec] bg-[#eef7ff] p-6 shadow-[0_18px_45px_rgba(7,40,77,0.08)] sm:min-h-[440px]">
            ...
            <div className="absolute left-5 top-5 rounded-lg bg-[#07284d] px-3 py-2 text-[10px] font-bold uppercase tracking-[0.16em] text-white">US home-service design focus</div>
