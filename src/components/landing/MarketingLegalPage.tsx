...
const CONTENT: Record<LegalKind, { title: string; intro: string; sections: { title: string; body: ReactNode }[] }> = {
  terms: {
    ...
    sections: [
      ...
      { title: "Management fee and advertising budget", body: <p>The management fee is normally <strong>$500 per week</strong>, unless a written agreement says otherwise. Advertising spend is separate and is paid directly to the relevant advertising platform from the customer&apos;s account. BarakahSoft does not charge a per-lead fee unless a separate written agreement expressly says so.</p> },
